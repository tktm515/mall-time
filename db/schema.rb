...
ActiveRecord::Schema.define(version: 2021_03_14_041956) do
  ...
  create_table "foods", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["tenant_id"], name: "index_foods_on_tenant_id"
  end
  ...
  create_table "reserves", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["food_id"], name: "index_reserves_on_food_id"
    t.index ["tenant_id"], name: "index_reserves_on_tenant_id"
  ...
  add_foreign_key "foods", "tenants"
  add_foreign_key "reserves", "foods"
  add_foreign_key "reserves", "tenants"
